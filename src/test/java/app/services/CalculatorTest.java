...
class CalculatorTest
{
    ...
    private static final String PASSWORD = "enilocin"; // We have used environment variables for security. Click main -> Edit Configurations -> Environment Variables -> Add password and ip
